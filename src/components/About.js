    ...
    <div className="about__container">
      <div className="about__work">
        <div className="work__intro">
          <p>
            Pokhara is always a hub for the event. Annually pokhara host
            hundreds of the events from pageants to corporate events to sports
            event. But looking at the context we always miss the company that
            comes with the complete package of the event. Then the name burn
            creative business consultancy with the active participation of the
            major vendors of the event industry with the aim to give new
            definition to event management. Creative business consultancy is a
            collaboration of the event vendors and especially focused on quality
            results in the budget of the organizer. CBC is especially a team of
            experts from where client can ask for all the management of the
            event or they can give specific job task or they can hire the staff
            on the related field only.
          </p>
        </div>
      </div>
      ...
      <div className="about_proudteammates">
        ...
        <div className="members">
          ...
          <div className="member">
            <p>
              <img src={manish} alt="Manish Jeshwal" className="team__pic" />
              <p>Manish Jeshwal</p>
              <p>"Creative Head"</p>
            </p>
          </div>
          <div className="member">
            <p>
              <img src={rakesh} alt="rakesh shrestha" className="team__pic" />
              <p>Rakesh Shrestha</p>
              <p>"MD"</p>
            </p>
          </div>
          <div className="member">
            <p>
              <img src={sagar} alt="sagar-acharya" className="team__pic" />
              <p>Sagar Acharya</p>
              <p>"Content Creator"</p>
            </p>
          </div>
          <div className="member">
            <p>
              <img src={ram} alt="ram-krishna" className="team__pic" />
