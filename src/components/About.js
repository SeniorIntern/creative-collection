    ...
    <div className='about__container'>
      <div className='about__work'>
        <div className='work__intro'>
          ...
          <p>
            We offer a wide branch services, from the most simple to the most
            complex. Our Goal is to meet the needs of our customers by offering
        ...
        <div className='ceo__container'>
          ...
          <div className='ceo__container__right'>
            ...
            <p>
              ...
              consequuntur doloribus accusantium blanditiis aliquam molestias,
              modi accusamus facilis amet quibusdam et ipsam provident sint quod
              eligendi fugiat, atque numquam quisquam.
            </p>
